(function (global) {
  ...
  // Tools holds Demo Data. The Create a Template tool was removed (its builder UI and
  // /template-rows endpoints are gone); templates already built with it still resolve
  // through the Create Tenant wizard, which reads saved TenantTemplateRow specs — that
  // path is untouched. The strip stays even at one tab: History and System Health use
  // the same renderer, and a future tool is a one-line addition to the registry below
  // rather than another hand-built section.
