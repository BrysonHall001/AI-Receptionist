      ...
      items: [
        ...
        },
        {
          ...
          blocks: [
            ...
            { p: "Some of what Clarity notices comes from the phone. If your receptionist is answering calls, it reads what CALLERS said \u2014 never its own side of the conversation \u2014 and tells you when the same subject keeps coming up, when a subject has started coming up far more than it used to, or when a lot of calls ended without a booking or a caller being captured.", features: ["receptionist"] },
            { p: "It stores only the short phrase and the counts \u2014 never the recording, never the wording around it, and never anything that looks like a phone number, an email, an address or somebody\u2019s name. Accepting one of these takes you to your receptionist\u2019s instructions so you can decide what it should say; it never writes those words for you. Each kind can be switched off on its own in Settings.", features: ["receptionist"] },
            { p: "Clarity also notices when you keep waving the same kind of suggestion away. Dismiss one kind three times without ever using it and it goes quiet for a couple of months, then comes back on its own. Keep dismissing it and it stays quiet longer, and eventually until you say otherwise. Accept one at any point and it goes straight back to normal \u2014 you have just told it you want that kind." },
            { p: "Nothing is ever hidden without a reason you can read. Settings lists every kind of suggestion with its state beside it: active, quiet until a date, or off because you switched it off yourself \u2014 and anything switched off has a button to switch it back on." },
