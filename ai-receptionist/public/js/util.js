(function (global) {
  ...
  App.util = App.util || {}; // hotfix: namespace must exist before these assignments (boot-order crash)
  ...
  Object.assign(App.util, { $, $$, el, esc, fmtDate, fmtDateOnly, statusBadge, roleLabel, toast, debounce }); // hotfix: merge, don't clobber the early skeleton helpers
  App.api = api;
