 ...
 *
 * Notes:
 *  - We DO NOT set the `welcomeGreeting` attribute. Instead, the opening line is
 ...
 *    the ElevenLabs voice speaks the generic opener (the business-specific intro
 *    comes from the Calls-page instructions via the AI prompt), reusing the same
 *    logic the walkie-talkie path uses.
