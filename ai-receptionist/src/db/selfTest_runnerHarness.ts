...
async function main() {
  ...
  check(gate.length === 53, `it names ${gate.length} suites (47 inherited from the hand-maintained block, plus the runner harness, selfTest_devToolsTabs and selfTest_widgetChrome)`);
