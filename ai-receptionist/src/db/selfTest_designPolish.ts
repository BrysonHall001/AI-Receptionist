...
check(/--control-placeholder: #6b6b74;/.test(css) && /::placeholder[^{]*\{ color: var\(--control-placeholder\); opacity: 1; \}/.test(css), "placeholder color tokenized (the ON-CONTROL class token; explicit literal per the heading-contrast hotfix)");
