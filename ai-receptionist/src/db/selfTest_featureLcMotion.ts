...
//
// Proves: (1) TAG INTEGRITY — every one of the 42 guides carries a features tag
...
function main() {
  ...
  check(total === 42 && GUIDES.length === 10, `the inventory holds: ${GUIDES.length} sections / ${total} guides`); // 42 since the estimates-lifecycle guide (Estimates Lifecycle batch)
