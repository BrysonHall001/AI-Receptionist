...
//
// Proves: (1) TAG INTEGRITY — every one of the 41 guides carries a features tag
...
function main() {
  ...
  check(total === 41 && GUIDES.length === 10, `the inventory holds: ${GUIDES.length} sections / ${total} guides`); // 41 since the customer-updates guide (Customer Comms batch)
