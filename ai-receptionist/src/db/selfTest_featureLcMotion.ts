...
//
// Proves: (1) TAG INTEGRITY — every one of the 43 guides carries a features tag
...
function main() {
  ...
  check(total === 47 && GUIDES.length === 10, `the inventory holds: ${GUIDES.length} sections / ${total} guides`); // 47 since the global-search guide (46 at suggestions, 45 at notifications, 44 at AI Intake)
