...
function main() {
  ...
  check(total === 45 && GUIDES.length === 10, `the inventory holds: ${GUIDES.length} sections / ${total} guides`); // 45 since the notifications guide (emergent layer 1; 44 at AI Intake, 43 at Recurring Work)
