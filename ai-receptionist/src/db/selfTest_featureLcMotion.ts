...
function main() {
  ...
  check(total === 46 && GUIDES.length === 10, `the inventory holds: ${GUIDES.length} sections / ${total} guides`); // 46 since the suggestions guide (emergent layer 2; 45 at notifications, 44 at AI Intake)
