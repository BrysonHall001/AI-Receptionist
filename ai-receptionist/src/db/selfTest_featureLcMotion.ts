...
//
// Proves: (1) TAG INTEGRITY — every one of the 40 guides carries a features tag
...
function main() {
  ...
  check(total === 40 && GUIDES.length === 10, `the inventory holds: ${GUIDES.length} sections / ${total} guides`); // 40 since the dispatch-calendar guide (Scheduling Calendar batch)
