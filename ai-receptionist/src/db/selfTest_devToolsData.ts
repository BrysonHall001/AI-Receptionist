...
async function main() {
  ...
  check(HEALTH_CHECK_KEYS.includes("errors") && HEALTH_CHECK_KEYS.length === 19 && adminJs.includes("errors: HW("), "the Errors tile lives in the registry with its accent widget"); // 19 since recurringWork (Recurring Work batch)
