...
async function main() {
  ...
  check(HEALTH_CHECK_KEYS.includes("errors") && HEALTH_CHECK_KEYS.length === 20 && adminJs.includes("errors: HW("), "the Errors tile lives in the registry with its accent widget"); // 20 since objectStorage (FS Punch List 1)
