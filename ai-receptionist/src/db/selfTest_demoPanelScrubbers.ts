...
async function main() {
  ...
  // CREATE A TEMPLATE REMOVED (comment only; the check below never required that tab). What
  // this assertion exists to protect is that the DETECTOR SWEEP tool is still gone - that is
  // unchanged.
