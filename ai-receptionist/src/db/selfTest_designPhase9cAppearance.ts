...
check(themeJs.includes('<span class="nav-item active">Home</span>') && themeJs.includes('class="widget-card thc-kpi"') && themeJs.includes("<thead><tr><th>Name</th><th>Status</th></tr></thead>") && themeJs.includes('class="btn btn-primary btn-sm thc-btn"'), "the mock is a mini HOME Dashboard (Home active; corrected KPI = widget card with the universal bar; header band; primary button)");
